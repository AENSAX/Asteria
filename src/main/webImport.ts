...
import { MEDIA_EXTENSIONS, WEB_MEDIA_MIME_EXTENSIONS } from '../shared/media.js';
...
export async function downloadWebMedia(url: string, queueId: number): Promise<string> {
...
function getWebMediaExtension(url: string, contentType: string | null): string | null {
