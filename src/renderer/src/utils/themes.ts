...
export function saveThemeSettings(settings: ThemeSettings): ThemeSettings {
  ...
  window.localStorage.setItem(THEME_SETTINGS_KEY, JSON.stringify(normalizedSettings));
...
export function listenThemeSettingsChanged(listener: (settings: ThemeSettings) => void): () => void {
...
export function applyTheme(themeId: ThemeId): void {
  ...
  for (const [name, value] of Object.entries(createThemeVariables(theme.palette))) {
